...
import { Box, Media, Container, Content, Heading } from 'react-bulma-components';
                ...
                <Media.Item>
                    <Container>     
                        <Content className="BoxItem">
                            <p>The approximate amount of storage you'll need to save all your songs as mp3 files</p>
                            <Heading className="Title">{(playlistCount * 3.516 * 0.001).toFixed(2) } GB</Heading>
                            <p>This value is based on 160 Kbps, approximately the sound quality you would get from a CD.</p>
                        </Content>
                    </Container>
                </Media.Item>
            </Media>
        ...
        <Box className="Box">
            <Media>
                <Media.Item>
                    <Container>     
                        <Content className="BoxItem">
                            <Heading className="Title">{playlistCount*3/60} hours</Heading>
